...
// On click, opens a pre-filled WhatsApp chat so the user
// doesn't have to type anything — lowering friction to zero.
...
const DEFAULT_MESSAGE =
  "Hello! I found your site and I'm interested in starting a business in Uganda. Can you help me?";
