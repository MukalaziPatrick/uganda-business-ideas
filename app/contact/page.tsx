      ...
      <section className="mx-auto max-w-5xl px-6 py-8 md:px-8 md:py-10">
        ...
        <section className="mt-8 grid gap-6 md:grid-cols-2">
          <div className="rounded-[28px] border border-brand-beige bg-brand-surface p-6 shadow-sm">
            <h2 className="text-xl font-bold text-brand-forest">Email</h2>
          ...
          <div className="rounded-[28px] border border-brand-beige bg-brand-surface p-6 shadow-sm">
            <h2 className="text-xl font-bold text-brand-forest">Phone / WhatsApp</h2>
            <p className="mt-4 text-sm leading-7 text-brand-green">
          ...
          <div className="rounded-[28px] border border-brand-beige bg-brand-surface p-6 shadow-sm md:col-span-2">
            <h2 className="text-xl font-bold text-brand-forest">Collaboration</h2>
            <p className="mt-4 text-sm leading-7 text-brand-green">
