...
export default function BottomNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 border-t border-brand-beige bg-brand-surface px-2 py-2 sm:px-6 z-50 pb-safe">
      <div className="mx-auto flex max-w-4xl items-center justify-between">
        {/* Home */}
        <Link href="/dashboard" aria-current="page" className="relative flex w-16 flex-col items-center gap-1 text-brand-forest">
           <span aria-hidden className="absolute -top-2 h-1 w-8 rounded-full bg-brand-gold" />
        ...
        {/* Plan (Soon) */}
        <div className="flex flex-col items-center gap-1 text-brand-green/45 cursor-not-allowed w-16">
           <div className="relative">
             ...
             <span className="absolute -top-1 -right-3 rounded bg-brand-beige px-1 text-[8px] font-bold text-brand-green">Soon</span>
           </div>
